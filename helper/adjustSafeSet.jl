...
if exist_feas_traj == 1 
    ...
    @show ind_start = convert(Int64,feasible_starting_indeces[index_of_traj_2_copy])
    ...
    println("copied s :$(oldTraj.oldTraj[ind_start,index_of_traj_2_copy][1]) from old round : $index_of_traj_2_copy, curr s: $(zCurr_s[iter,1])")
