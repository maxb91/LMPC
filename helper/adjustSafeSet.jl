...
#                 activate dummy traj in mpc solver
    #     ssAddTraj = 1
    # else
    # oldTraj.oldTraj[:,:,oldTraj.n_oldTraj]  =ones(size(oldTraj.oldTraj[:,:,oldTraj.n_oldTraj]))
    # oldTraj.oldNIter[oldTraj.n_oldTraj] = buffersize
    # oldTraj.cost2Target[:,oldTraj.n_oldTraj] = buffersize*ones(size(oldTraj.cost2Target[:,oldTraj.n_oldTraj]))
    # oldTraj.curvature[:,oldTraj.n_oldTraj] = ones(size(oldTraj.curvature[:,oldTraj.n_oldTraj]))

    oldTraj.oldTraj[:,:,oldTraj.n_oldTraj]  =10*oldTraj.oldTraj[:,:,oldTraj.n_oldTraj-1]
